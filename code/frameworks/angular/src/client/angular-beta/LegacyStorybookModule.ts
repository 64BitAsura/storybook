...
import {ICollection, LegacyStoryFnAngularReturnType} from '../types';
...
import {createLegacyStorybookWrapperComponent} from "./LegacyStorybookWrapperComponent";
...
export const getLegacyStorybookModuleMetadata = (
  {
    storyFnAngular,
   ...
   */
  const ComponentToInject = createLegacyStorybookWrapperComponent(
    targetSelector,
    template,
    component,
    styles,
...
export const createLegacyStorybookModule = (ngModule: NgModule): Type<unknown> => {
  @NgModule(ngModule)
